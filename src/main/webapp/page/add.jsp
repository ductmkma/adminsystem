		...
		<div class="row">
			<div class="col-md-12 col-sm-12 col-xs-12">
				<div class="x_panel">
					...
					<div class="x_content">
						<form:form modelAttribute="userDTO" action="add" method="post"
								...
								<div class="form-group">
									...
									<div class="input-group">
										<span class="input-group-btn"> <span
											...
											<form:input path="image" type="file" id="imgInp" name="avata" />
										</span>
							...
							<div class="col-md-8">
								...
								<div class="col-md-12 input-group date" id='myDatepicker2'>

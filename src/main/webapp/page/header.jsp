...
<html lang="en">
  <head>
    ...
    <link href='<c:url value="/resources/vendors/bootstrap-datetimepicker/build/css/bootstrap-datetimepicker.min.css"/>' rel="stylesheet">
    <!-- Dropzone -->
    <link href='<c:url value="/resources/build/css/sweetalert.css"/>' rel="stylesheet">
    <link href='<c:url value="/resources/build/css/toastr.min.css"/>' rel="stylesheet">
                ...
                <ul class="nav side-menu">
                  <li><a><i class="fa fa-home"></i> Home <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="<%=request.getContextPath()%>">Quản lý người dùng</a></li>
                      <li><a href="<%=request.getContextPath()%>/role">Danh mục vai trò</a></li>

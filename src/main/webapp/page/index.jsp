												...
												<li><a>${menu.name}<span class="fa fa-chevron-down"></span></a>
													<ul class="nav child_menu">
														<c:forEach items="${menu.submenus}" var="submenu">
															...
															<li class="sub_menu"><a href="<%=request.getContextPath()%>/${submenu.url}">${submenu.name}</a></li>
															</c:if>
															<c:if test="${submenu.parent.id==menu.id&&submenu.submenus.size()>0}">
																<li><a>${submenu.name}<span class="fa fa-chevron-down"></span></a>
																	<ul class="nav child_menu">
																		<c:forEach items="${submenu.submenus}" var="submenu3">
																			<li class="sub_menu"><a href="<%=request.getContextPath()%>/${submenu3.url}">${submenu3.name }</a></li>
																		</c:forEach>
																	</ul></li>
															</c:if>
														</c:forEach>

...
<%@ taglib prefix = "c" uri = "http://java.sun.com/jsp/jstl/core" %>
  <!-- footer content -->
    ...
    <script src='<c:url value="/resources/build/js/sweetalert.min.js"/>'></script>
    <script src='<c:url value="/resources/build/js/toastr.min.js"/>'></script>
     <script src='<c:url value="/resources/build/js/jquerysession.js"/>'></script>
